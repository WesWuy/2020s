...
Daily Chaos generates one deterministic challenge from the current date. Every player gets the same daily setup: required character, starting cycle, special rule, and goal. No backend is required.

## Printable Pages

- `/docs/print-rules.html`
- `/docs/print-board.html`
- `/docs/print-characters.html`
- `/docs/print-cards.html`
...
- **v0.1:** text-first concept and rules spine.
